...
// Source: github/islmaghany/bank/db/sqlc (interfaces: Store)
...
// GetAccoutForUpdate mocks base method.
func (m *MockStore) GetAccoutForUpdate(arg0 context.Context, arg1 int64) (db.Account, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetAccoutForUpdate", arg0, arg1)
	ret0, _ := ret[0].(db.Account)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// GetAccoutForUpdate indicates an expected call of GetAccoutForUpdate.
func (mr *MockStoreMockRecorder) GetAccoutForUpdate(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetAccoutForUpdate", reflect.TypeOf((*MockStore)(nil).GetAccoutForUpdate), arg0, arg1)
}
